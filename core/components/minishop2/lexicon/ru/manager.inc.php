...
$_lang['ms2_time'] = 'Срок доставки';
$_lang['ms2_time_help'] = 'Срок доставки товара.<br>Может быть использовано в кастомных классах.';
$_lang['ms2_order_fields'] = 'Возможные поля';
$_lang['ms2_order_fields_help'] = 'При оформлении заказа, будут отображаться только эти поля, остальные будут скрываться.';
$_lang['ms2_cache_time'] = 'Кэширование';
$_lang['ms2_cache_time_help'] = 'Кэширование результатов расчета стоимости доставки (укаывать в минутах)';
